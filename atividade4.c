...
int main(void) {
    ...
    while (!WindowShouldClose()) {
        ...
        BeginDrawing();
            ...
            DrawText("ESPACO atira no inimigo vivo mais proximo | Tecla C cura todos os inimigos", 10, 10, 20, DARKGRAY);
